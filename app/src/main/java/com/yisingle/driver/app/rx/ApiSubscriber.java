package com.yisingle.driver.app.rx;


import com.yisingle.baselibray.base.BaseView;
import com.yisingle.driver.app.http.ErrorHandler;
...
public abstract class ApiSubscriber<T> extends Subscriber<T> {
     ...
     */
    public ApiSubscriber(BaseView mBaseView, boolean showToast, int type) {
        this.mBaseView = mBaseView;
     ...
     * @param showToast 是否显示toast
     */
    public ApiSubscriber(BaseView mBaseView, boolean showToast, boolean isshowLoading, int type) {
        this.mBaseView = mBaseView;
        this.showToast = showToast;
