...
import com.yisingle.driver.app.MainApplication;
import com.yisingle.driver.app.base.Constant;
import com.yisingle.driver.app.base.LoginConstant;
import com.yisingle.driver.app.data.HeartBeatData;
...
public class WebSocketManager extends WebSocketListener {
    ...
    public void connectWebSocket() {
        ...
        if (sWebSocket == null) {
            ...
            int driverId = SPUtils.getInstance().getInt(LoginConstant.LOGIN_DRIVER_ID);
            Request request = new Request.Builder().header("driverId", driverId + "").url(Constant.getWsBaseUrl() + "yisingle/websck").build();
